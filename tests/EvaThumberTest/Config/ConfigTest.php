...
namespace EvaThumberTest\Config;
...
class ConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('EvaThumber\Exception\RuntimeException', 'Config is read only');
    ...
    public function testUnsetException()
    {
        ...
        $this->setExpectedException('EvaThumber\Exception\InvalidArgumentException', 'is read only');
    ...
    public function testMerge()
    {
        ...
        // config->numerical-> ...
        $this->assertInstanceOf('\EvaThumber\Config\Config', $configA->numerical);
        $this->assertEquals('first', $configA->numerical->{0});
        $this->assertEquals('second', $configA->numerical->{1});

        // config->numerical->{2}-> ...
        $this->assertInstanceOf('\EvaThumber\Config\Config', $configA->numerical->{2});
        ...
        // config->numerical->{5}
        $this->assertInstanceOf('\EvaThumber\Config\Config', $configA->numerical->{5});
        $this->assertEquals('sixth', $configA->numerical->{5}->{0});
        $this->assertEquals(null, $configA->numerical->{5}->{1});

        // config->misaligned
        $this->assertInstanceOf('\EvaThumber\Config\Config', $configA->misaligned);
        ...
        // config->mixed
        $this->assertInstanceOf('\EvaThumber\Config\Config', $configA->mixed);
